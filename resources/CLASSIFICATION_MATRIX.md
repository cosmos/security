...
If you are a chain operator and you want to verify if Emergency Security Coordination for an Cosmos Stack component is taking place, please reach out to our official channel by emailing [security@cosmos.network](mailto:security@cosmos.network). Though our team cannot make public announcements about private security coordination activities, we can privately confirm if any emergency coordination is actively taking place.
